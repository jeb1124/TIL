	...
	public static void main(String[] args) {		
		...
		aaa : while(true)
		{
			...
			case 0: 
				break;
			case 1:
//				bm.add(new Book("111", "자바", "A", "한빛", 10000, "aaaa"));
//				bm.add(new Magazine("222", "씨네21", "B", "동아", 18000, "bbbb", 2019, 12));
//				bm.add(new Book("333", "C++", "C", "동아", 21000, "cccc"));
//				bm.add(new Magazine("444", "python", "D", "한빛", 15000, "dddd", 2020, 6));
			...
			case 5:
				...
				break;
			case 6:
				ArrayList<Book> returnList2=mgr.onlySearchMagazine();
			...
			case 8:
				...
				ArrayList<Book> returnList4=mgr.searchBookByPublisher(name3);
